<template>
  <div>
      <div>
          <div class="card custom-bg border-0 mb-5 ">
            <div class="card-header border-0 p-2">
              <div class="w-100 text-center">
                <b class="text-bold">Payments</b>
            ...
            <div class="card-body p-0">
              <!-- <div class="border m-1 p-2 shadow-sm" id="cumplusoryFeeMakePayment">
                ...
                <input type="number" class="form-control form-control-sm" v-model="cumplusoryAmountToBePaid" placeholder="Enter the amount to be paid" />
              </div> -->
              <ul class="list-group">
                <li
...
export default {
  ...
  computed: {
    cumplusoryFee(){
      return this.$store.state.studentBillPerProg.cumplusoryFee;
    },
    optionalFee(){
      return this.$store.state.studentBillPerProg.optionalFee;
    }
  },
  methods: {
    fee(){
     let fee = [... this.cumplusoryFee , ...this.optionalFee]
     return fee;
    },
